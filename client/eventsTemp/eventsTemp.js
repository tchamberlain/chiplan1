...
Template.eventsTemp.onCreated( function(){
  ...
  //checks if there is a list of activities for the user to browse
  ...
  //update has swiped again --- the user will be cued to swipe once on the mobile device, so they know they can swipe thru events
  if(Meteor.user()){
...
Template.eventsTemp.onRendered( 
  function(){
